...
public extension HandyJSON {
    ...
    public static func deserialize(from data:Data,designatedPath: String? = nil) -> Self? {
        ...
        return JSONDeserializer<Self>.deserializeFrom(json: jsonString, designatedPath: designatedPath)
        
    }
    
    //dic to model
    public static func deserialize(from dict: Dictionary<String, Any>?, designatedPath: String? = nil) -> Self? {
        
        let mutableDic = NSMutableDictionary()
        
        if dict != nil {
            mutableDic.addEntries(from: dict!)
        }
        
        //  let xx = NSDictionary(dict)
        return JSONDeserializer<Self>.deserializeFrom(dict: mutableDic, designatedPath: designatedPath)
    }
